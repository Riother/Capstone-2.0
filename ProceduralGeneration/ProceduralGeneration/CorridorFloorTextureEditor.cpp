...
CorridorFloorTextureEditor::CorridorFloorTextureEditor()
{
...
void CorridorFloorTextureEditor::update()
{
	dmns = dimensions->getSpinboxValue();
	r = red->getSpinboxValue();
	g = green->getSpinboxValue();
...
void CorridorFloorTextureEditor::FloorPattern()
{
	...
	cTexture = RENDERER.addTexture(newImage);
	//return newImage;
}

int CorridorFloorTextureEditor::getTexture()
{
	return cTexture;
}
